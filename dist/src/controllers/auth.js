...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newUser = yield User.create(Object.assign(Object.assign({}, req.body), { password: hashPassword, avatarURL,
        verificationToken }));
    const verifyEmail = {
        to: email,
...
const verifyEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield User.findOne({ verificationToken });
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield User.findByIdAndUpdate(user._id, { token });
    res.json({
        token,
        user: {
            email,
...
const logout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.user;
    yield User.findByIdAndUpdate(_id, { token: "" });
    res.status(204).json({
