...
router.post("/", authenticate, validateBody(contactSchemas.createContactSchema), contactsController.createContact);
router.get("/:contactId", authenticate, isValidId, contactsController.getById);
router.put("/:contactId", authenticate, isValidId, validateBody(contactSchemas.createContactSchema), contactsController.updateById);
